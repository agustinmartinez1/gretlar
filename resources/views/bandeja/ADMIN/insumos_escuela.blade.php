                                        ...
                                        <tbody>
                                                    ...
                                                    <form method="POST" action="{{ route('crearPedido') }}" class="formularioNuevoPedido form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <label for="Observacion">Hacer Pedido</label><br>
                                                                <textarea class="form-control" name="Observaciones" rows="3" cols="100%"></textarea>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                                <input type="hidden" name="recurso" value="{{$nag->idRecurso}}">
                                                                <button type="submit" name="btnAgregarAgenteNuevo" class="btn mx-1">
                                                                    <i class="fa fa-cog text-green"></i> <br>Solicitar Reparaci&oacute;n
                                                                </button>
                                                        </td>
                                                    </form>
                                                </tr>       
                                            ...
                                            @else
                                                <div class="alert alert-warning alert-dismissible">
                                                    ...
                                                    No se ha registrado ningún Recurso Asignado
                                                </div>
                                            @endif          
                                        </tbody>
                                    </table>
